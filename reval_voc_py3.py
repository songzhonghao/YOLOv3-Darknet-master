...
def parse_args():
    ...
    parser.add_argument('--output_dir', dest='output_dir', nargs=1, help='results directory',
                        default='results', type=str)
    parser.add_argument('--voc_dir', dest='voc_dir', default='E:/Datasets/VOC', type=str)
    ...
    parser.add_argument('--classes', dest='class_file', default='data/ship.names', type=str)
